...
var toggleBskTimer = new Boolean(true);
var toggleAwaTimer = new Boolean(true);
var toggleSakaiNdTimer = new Boolean(true);
var toggleSakaiHeadGlassTimer = new Boolean(true);
var toggleSakaiSkillBlock = new Boolean(true);
var toggleYami2v2NTimer = new Boolean(true);
var toggleAutoGg = new Boolean(true);
var toggleXenTimer = new Boolean(true);
var toggleHuuinGimicTimer = new Boolean(true);
var toggleTokoyamiNumberDetection = new Boolean(true);
var toggleWhite1TpTimer = new Boolean(true);
var toggleWhiteCtTimer = new Boolean(true);
var toggleSakaiChatPuzzle = new Boolean(false);
var toggleSakaiChatSpider = new Boolean(false);
...
if (toggleTokoyamiNumberDetection){
  let lastTitle = ""
  let currentTitle = ""
  let numSum = 0
  let numAns = 0
